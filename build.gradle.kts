...
//    implementation("io.micronaut.serde:micronaut-serde-jackson")
    ...
    aotPlugins("io.micronaut.security:micronaut-security-aot:4.5.1")
    ...
    // mail
    implementation("org.simplejavamail:simple-java-mail:8.6.1")
    implementation("org.simplejavamail:batch-module:8.6.1")
    implementation("org.simplejavamail:authenticated-socks-module:8.6.1")
